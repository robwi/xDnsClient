...
Import-LocalizedData LocalizedData -filename xDnsClient.strings.psd1 -ErrorAction SilentlyContinue
Import-LocalizedData USLocalizedData -filename xDnsClient.strings.psd1 -UICulture en-US -ErrorAction SilentlyContinue
